    ...
    return (
        <div className="Principal">
            ...
            <div className="displayCountries">
                <div className="searchCountryAll">
                    <div className="searchCountry">
                        <form className="formOne" onSubmit={(e)=> e.preventDefault()}>
                            ...
                            <input placeholder="Search for a country" onChange={(e) =>  setsearchCountry(e.target.value)} value={searchCountry}/>
                        </form>

                        <form className="formTwo">
                        <select name="dropdown" onChange={(e) => { setregionn(e.target.value) }}>
               ...
               {country && country
               .filter((elem) => elem.name.toUpperCase().includes(searchCountry.toUpperCase()))
               .filter(elem=>{
